...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('ionic-angular/index'), require('@angular/forms'), require('moment')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'ionic-angular/index', '@angular/forms', 'moment'], factory) :
	(factory((global.i2e = global.i2e || {}, global.i2e.calendar = global.i2e.calendar || {}),global.ng.core,global.ng.common,global.ing,global.ng.forms,global.moment));
}(this, (function (exports,_angular_core,_angular_common,ionicAngular_index,_angular_forms,moment__default) { 'use strict';
...
/**
  ...
  * License: GPLv3
  */
var momentConstructor = moment__default__default || moment__default;
...
var IonCalendar = (function () {
    ...
    Object.defineProperty(IonCalendar.prototype, "startOfWeekDay", {
        ...
        set: function (weekDay) {
            ...
            moment__default.updateLocale(moment__default.locale(), { week: { dow: this._startOfWeekDay } });
...
IonCalendar.decorators = [
    { type: _angular_core.Component, args: [{ selector: 'ion-calendar',
...
IonCalendar.ctorParameters = function () { return [
    { type: ionicAngular_index.Form, },
]; };
IonCalendar.propDecorators = {
    'ionChange': [{ type: _angular_core.Output },],
    'viewDate': [{ type: _angular_core.Input, args: ['view-date',] },],
    'disabled': [{ type: _angular_core.Input },],
    'dateOnlyForDay': [{ type: _angular_core.Input },],
    'viewMode': [{ type: _angular_core.Input, args: ['view-mode',] },],
    'selectionMode': [{ type: _angular_core.Input, args: ['selection-mode',] },],
    'startOfWeekDay': [{ type: _angular_core.Input, args: ['start-of-week-day',] },],
...
IonCalendarModule.decorators = [
    { type: _angular_core.NgModule, args: [{
                imports: [_angular_common.CommonModule, ionicAngular_index.IonicModule],
                exports: [IonCalendar],
